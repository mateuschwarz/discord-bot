...
# define
CWD = Path(__file__).parents[2] # current working directory
EXT_PATH = "extensions" # extension path
CLIENT_CFG = os.path.join(CWD, "data/client.json") # client config file
OPTIONS_CFG = os.path.join(CWD, "data/options.json") # options config file
...
class Commands(commands.Cog):
    ...
    def __init__(self, client):
        ...
        with open(OPTIONS_CFG) as f:
            self.options_cfg = json.load(f)
    ...
    async def on_ready(self):
        ...
        ACTIVITY = discord.Activity(**self.options_cfg['Activity'])
    ...
    async def load(self, ctx, extension):
        ...
        try:
            ...
            self.client.load_extension(f'{EXT_PATH}.{extension}')
    ...
    async def unload(self, ctx, extension):
        ...
        try:
            ...
            self.client.unload_extension(f'{EXT_PATH}.{extension}')
